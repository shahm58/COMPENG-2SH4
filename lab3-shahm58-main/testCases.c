...
//=========Question 1==================================
	...
	void TestQ1_two_strings_2(CuTest *tc) {
		...
		CuAssertStrEquals(tc, "WaterBottle", my_strcat("Water","Bottle"));
	}
...
//=================Question 2================================
	void TestQ2_find_notThere(CuTest *tc) {
		...
		char inputFile[] =  "lab3-shahm58/students.txt";
		int size;
	...
	void TestQ2_find_notThere_2(CuTest *tc) {
		...
		int expected = -1;
		int actual = find(2020,Clist,size);
	...
	void TestQ2_inputGradesAndCalculateFinal(CuTest *tc) {
		...
		char inputFile[] =  "lab3-shahm58/students.txt";
		char gradesFile[] =  "lab3-shahm58/grades.txt";
		int size;
		//create list using the input file
		student **Clist = create_class_list(inputFile,&size);
		...
		output_final_course_grades("lab3-shahm58/outputGrades.txt",Clist,size);

		//now we open the golden file with the written file and compare line by line

		char actualFile[] =  "lab3-shahm58/outputGrades.txt";
		char goldenFile[] =  "lab3-shahm58/output.txt";
...
//===========================================================
	CuSuite* Lab3GetSuite() {
		...
		SUITE_ADD_TEST(suite, TestQ2_find_notThere_2);
