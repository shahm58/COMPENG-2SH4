...
void testSLLSetIntArray_shahm58() {

        int arr[] = {1, 2, 3, 7, 8, 5, 9, 8}; // this list

        SLLSet listObj2 = SLLSet(arr,8);
        string expectedSet = "1, 2, 3, 7, 8, 5, 9, 8";
        int expectedSize = 8;
        ASSERT_EQUAL(expectedSize,listObj2.getSize());
        ASSERT_EQUAL(expectedSet,listObj2.toString());
	}
...
void testIsInTrue_shahm58() {

    int arr[] = {1, 2, 3, 7, 8, 6, 7, 8, 9}; // this list
...
bool runAllTests(int argc, char const *argv[]) {
	...
	s.push_back(CUTE(testSLLSetIntArray_shahm58));
	s.push_back(CUTE(testIsInTrue_shahm58));
	s.push_back(CUTE(testIsInFalse_shahm58));
	s.push_back(CUTE( testAdd1_shahm58));
	s.push_back(CUTE(testRemove1_shahm58));
	s.push_back(CUTE(testRemove2_shahm58));
