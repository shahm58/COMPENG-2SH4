...
CuSuite* Lab1GetSuite() {
	...
	SUITE_ADD_TEST(suite, TestQ2_edge);
	SUITE_ADD_TEST(suite, TestQ2_edge2);
	...
	SUITE_ADD_TEST(suite, TestQ3_pass);
	SUITE_ADD_TEST(suite, TestQ3_failed);
	...
	SUITE_ADD_TEST(suite, TestQ4_pi);
	...
	SUITE_ADD_TEST(suite, TestQ6_7500);
